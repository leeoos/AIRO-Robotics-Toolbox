%% DH transformation matrices and direct kinematics of a serial robot (Midterm 18.11.22)
%% Author Massimo
...
syms L H theta1 d2 theta3 

%% number of joints of UR10

N=3;

%% Insert DH table of parameters

DHTABLE = [pi/2, 0, H,  theta1;
           pi/2, 0, d2, pi/2;
           pi/2, L, 0, theta3]
